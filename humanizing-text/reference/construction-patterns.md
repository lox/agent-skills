...
1. Compare the draft with any source samples as outlines.
2. Record stable choices: entry point, reveal order, branching, references, reader relationship, uncertainty, and ending shape.
3. Treat those choices as the target. Do not normalise an unusual but genuine structure towards this guide's examples.
4. For short or functional text, use only the questions relevant to its job. A changelog should usually be tidy and linear.

## Thematic over-determination

**C1. Thesis over-restatement**
...
**C2. Explicit significance labeling**
"The key insight is", "This matters because", "The important thing to understand". The prose repeatedly announces meaning instead of carrying it.
- Evidence: **Nonfiction adaptation** of the same thematic over-determination findings.
- Fix: delete the label, keep the material. If the material can't carry the point alone, the problem is the material.

**C3. Total thematic unity**
...
**C4. Single-track argument**
The piece presents one continuous causal chain. Counterexamples, dependencies, and side effects appear only when they can be absorbed into it.
- Evidence: **Nonfiction adaptation** of tighter causal chains and fewer subplots in AI fiction.
- Fix: restore a real side condition, failed path, or competing cause when the evidence contains one. Do not invent branching for texture.

## Tidy resolution

**C5. Every tension resolved**
Objections are raised only to be immediately answered; tradeoffs are stated then dissolved.
- Evidence: **Nonfiction adaptation** of AI fiction's internal resolution, protagonist-driven closure, and reduced moral ambivalence.
- Fix: state the actual residual cost or open question. Never create uncertainty the author does not hold.

## Performed texture

**C6. Sensory and embodied performance**
...
**C11. Flattened verdicts**
The conclusion is wholly positive, wholly negative, or mechanically balanced into equal pros and cons. It loses the author's specific mix of commitment and discomfort.
- Evidence: **Nonfiction adaptation** of the human-fiction preference for morally ambivalent protagonists and less internally resolved endings.
- Fix: preserve the author's actual weighting. "This is the right call and it still annoys me" is useful only when both halves are true.

## Structural uniformity

**C12. Uniform section shape**
